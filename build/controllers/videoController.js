    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 13:
            req.flash("sucess", "Your video has been updated");
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            console.log("postUploadLog", video[0], thumb[0]);
            ...
            return _Video["default"].create({
              title: title,
              description: description,
              fileUrl: isHeroku ? video[0].location : video.path[0],
              thumbUrl: isHeroku ? thumb[0].location : video.path[0],
              owner: _id,
              hashtags: _Video["default"].formatHashtags(hashtags)
            });
          case 8:
...
var deleteComment = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var _id, _req$params, commentId, id, comment, videoId, video;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _id = req.session.user._id, _req$params = req.params, commentId = _req$params.commentId, id = _req$params.id;
            _context10.next = 3;
